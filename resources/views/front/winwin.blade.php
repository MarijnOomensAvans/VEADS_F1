    ...
    <section class="wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
        <div class="container-fluid padding-five-lr">
            <div class="row">
                <div class="col-md-7 col-sm-12 col-xs-12 center-col text-center margin-100px-bottom xs-margin-40px-bottom">
                    <div class="position-relative overflow-hidden width-100">
                        <span class="text-extra-large text-outside-line-full alt-font font-weight-800">Ik help mee</span>
                    </div>
                </div>
            </div>
            <div class="row equalize xs-equalize-auto">
                <!-- start logo item -->
                <a href="#">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 banner-style1 md-margin-30px-bottom wow fadeInUp" style="visibility: visible; animation-name: fadeInUp; height: 500px;">
                ...
                <!-- start logo item -->
                <a href="#">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 banner-style1 sm-margin-30px-bottom wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp; height: 500px;">
                    <figure class="bg-extra-dark-gray">
                ...
                <!-- start logo item -->
                <a href="#">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 banner-style1 wow fadeInUp" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp; height: 500px;">
                    <figure class="bg-extra-dark-gray">
