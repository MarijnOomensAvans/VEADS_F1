            ...
            <div class="block-content">
                ...
                <div class="row mb-3">
                    <div class="col-12 text-right">
                        <div class="btn-group">
                            <a href="{{ action('Backend\DonationController@index') }}" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Terug naar alle donaties"><span class="fas fa-arrow-left"></span></a>
                            @if(empty($donation->refunded_at))
