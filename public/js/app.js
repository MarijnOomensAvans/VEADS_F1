...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['event', 'position', 'published', 'name'],
  components: {
  ...
  methods: {
    ...
    getEvent: function getEvent(id) {
      ...
      axios.get('/admin/events/' + id + '?json=true').then(function (response) {
        ...
        _this2.eventSearch = response.data.name;
      });
    },
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("p", [
        _vm._v("Geselecteerd event: " + _vm._s(_vm.selectedEvent.name))
      ]),
      _vm._v(" "),
      _c("input", {
        directives: [
...
__webpack_require__(/*! /Users/daanvanberkel/Desktop/repos/VEADS_F1/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/daanvanberkel/Desktop/repos/VEADS_F1/resources/sass/app.scss */"./resources/sass/app.scss");
