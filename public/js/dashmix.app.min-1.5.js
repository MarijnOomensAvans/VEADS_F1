...
! function (e) {
            ...
            value: function () {
                ...
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').addClass("active"), this._lPage.off("click.pixelcave.themes"), this._lPage.on("click.pixelcave.themes", '[data-toggle="theme"]', function (t) {
                    ...
                    var o = jQuery(t.currentTarget),
                        r = o.data("theme");
                    jQuery('[data-toggle="theme"]').removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + r + '"]').addClass("active"), n.updateTheme(e, r), e = jQuery("#css-theme"), a && Cookies.set("dashmixThemeName", r, {
                        expires: 7
                    }), o.blur()
                })
            }
    ...
    var f = function (e) {
        function a() {
            ...
            return function (e, a) {
                if (!(e instanceof a)) throw new TypeError("Cannot call a class as a function")
            }(this, a), e = p(this, h(a).call(this)), "demo.pixelcave.com" == location.hostname && (jQuery("body").html(""), location.href = "https://1.envato.market/r6y"), e
        }
        return function (e, a) {
